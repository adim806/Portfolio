...
export const Hero = () => {
 return <section className='relative min-h-screen flex items-center overflow-hidden'>
    ...
    <div className='absolute inset-0'>
        <img src="/test.jpg" alt="Hero image" className='w-full h-full object-cover opacity-40' />
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-8'>
                ...
                <div className='flex flex-wrap gap-4 animate-fade-in animation-delay-300'>
                  ...
                  <a href="/CV - Adi Meller.pdf" download="CV - Adi Meller.pdf">
                ...
                <div className='flex items-center gap-4 animate-fade-in animation-delay-400'>
                    ...
                    {[
                        {icon: Github, href: 'https://github.com/adim806'},
                        {icon: Linkedin, href: 'https://www.linkedin.com/in/adi-meller1/'},
                ...
                <div className='flex animate-marquee'>
                    {[...skills, ...skills].map((skill,idx)=>(
                        <div key={idx} className='flex-shrink-0 px-8 py-4'>
                            <span className='text-xl font-semibold text-muted-foreground/50 hover:text-muted-foreground transtion-colors'>{skill}</span>
                        </div>
                    ))}
                </div>
            </div>
